...
|  구현단계  | - 교사/교육생/관리자 로그인 기능 구현<br />- 교육생 로그인시 간략한 교육생 정보(참여중인 과정명, 강의실, 출석률그래프) 조회 기능 구현<br />- 교육생 출결 전체 조회 기능 구현<br />- 교육생 출결 월별 조회(달력형식) 기능 구현<br />- 교육생 출결 일별 조회 기능 구현 <br />\- 교육생 출결 입력 기능 구현<br />\- 교육생 강의 평가 조회 기능 구현<br />\- 교육생 강의 평가 입력 기능 구현<br />\- 교육생 구인 정보 조회 기능 구현 |
